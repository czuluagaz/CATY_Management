...
#dataset = 'data_storage/raw_data.tsv'
...
def csv_to_json(dataset):
    ...
    # rename the columns
    df.rename(columns={'date':'date_meas','T av':'temp_av_month', 'days':'days_cons', 'gaz m3':'gas_meas_m3', 'cons gaz':'gas_cons_m3', 'av day':'gas_av_day_cons_m3', 'Unnamed: 6': 'gas_m3_to_kwh_1', 'Unnamed: 7':'gas_m3_to_kwh_2', 'water m3':'water_meas_m3', 'cons':'water_cons_m3','av day.1':'water_av_day_cons_m3', 'power kw/h':'power_meas_kw/h', 'cons power':'power_cons_kw/h', 'av day.2':'power_av_cons_day_kw/h' }, inplace=True)
    ...
    df['temp_av_month'] = pd.to_numeric(df['temp_av_month'], errors='coerce') # convert the column to numeric
    # chnage NaN to null
